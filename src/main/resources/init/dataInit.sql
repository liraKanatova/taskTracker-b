...
values (1, 'title', 'Чарльз Бэббидж считается пионером вычислительной техники. Бэббидж имел чёткое представление о механических вычислениях чисел и таблиц.', false, '2023-09-07', 1, 1),
       ...
       (10, 'word', 'Чарльз Бэббидж считается пионером вычислительной техники. Бэббидж имел чёткое представление о механических вычислениях чисел и таблиц. ', false, '2023-09-16', 9, 5),
       ...
       (13, 'title', 'Чарльз Бэббидж считается пионером вычислительной техники. Бэббидж имел чёткое представление о механических вычислениях чисел и таблиц.', false, '2023-09-20', 10, 5),
       (14, 'word', 'К 1830 году Бэббидж придумал план, как разработать машину, которая могла использовать перфокарты для выполнения арифметических операций.', false, '2023-09-21', 15, 2),
